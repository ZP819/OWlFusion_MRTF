 ...
 *
 * Purpose:
 *	Header for SPxTargetDataOutputTTM class which supports
 *	encoding a received stream of SPx Extended tracks as TTM Tracks
...
#ifndef _SPX_TARGET_DATA_OUTPUT_TTM_H
#define _SPX_TARGET_DATA_OUTPUT_TTM_H
...
class SPxTargetDataOutputTTM : public SPxTargetDataOutput
{
public:
    /*
     * Public functions.
    ...
    SPxTargetDataOutputTTM(SPxTargetDataFilter *dataSrc,
                           SPxExtHeartbeatSender *hbSender);
    virtual ~SPxTargetDataOutputTTM(void);
...
}; /* SPxTargetDataOutputTTM */

#endif /* _SPX_TARGET_DATA_OUTPUT_TTM_H */
