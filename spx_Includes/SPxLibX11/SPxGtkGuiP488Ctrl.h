...
*
* Purpose:
*	Header for re-usable P488 Source Control GTK dialog.
*
*
* Revision Control:
...
#ifndef _SPX_GTK_GUI_P488_CTRL_H
#define _SPX_GTK_GUI_P488_CTRL_H
...
class SPxGtkGuiP488Ctrl : public SPxGtkGuiCtrl
{
public:
    /* Public functions. */
    explicit SPxGtkGuiP488Ctrl(SPxNetworkReceiveP488 *obj);
    virtual ~SPxGtkGuiP488Ctrl(void);
...
private:
    /* Private variables. */
    SPxNetworkReceiveP488 *m_obj;   /* The object we are controlling. */
...
extern void on_p488_end_range_spin_value_changed(GtkSpinButton *spinbutton,
					         gpointer user_data);
extern void on_p488_gain_spin_value_changed(GtkSpinButton *spinbutton,
					    gpointer user_data);
extern void on_p488_period_mult_spin_value_changed(GtkSpinButton *spinbutton,
						   gpointer user_data);
...
#endif /* _SPX_GTK_GUI_P488_CTRL_H */
