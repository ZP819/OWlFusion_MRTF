...
*
* Purpose:
*	Header for SPxRemoteP430Ctrl class, which allows client
*	applications to remoteley control P430 radars via SPxServer.
*
*
* Revision Control:
...
#ifndef _SPX_REMOTE_P430_CTRL_H
#define _SPX_REMOTE_P430_CTRL_H
 ...
 * Define our class.
 */
class SPxRemoteP430Ctrl : public SPxRemoteRadarCtrl
{
public:
    ...
    SPxRemoteP430Ctrl(void);
    SPxRemoteP430Ctrl(const char *addr, unsigned int port);
    explicit SPxRemoteP430Ctrl(SPxRemoteServer *srvConnection);
    virtual ~SPxRemoteP430Ctrl(void){}
